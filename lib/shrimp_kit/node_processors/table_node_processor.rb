module ShrimpKit
  module TableNodeProcessor
    ...
    def self.included(by)
      by.send :alias_method, :process_th_node, :process_td_node
      by.send :alias_method, :process_thead_node, :process_tbody_node
      by.send :alias_method, :process_tfoot_node, :process_tbody_node
    end
  end # TableNodeProcessor
end # ShrimpKit
